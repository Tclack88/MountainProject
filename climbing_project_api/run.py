...
from pages import index, pyramid # predictions, insights, process
...
navbar = dbc.NavbarSimple(
    ...
    brand_href='/', 
    children=[
        dbc.NavItem(dcc.Link('Pyramid', href='/pyramid', className='nav-link')), 
        ...
        dbc.Col(
            html.P(
                [
                    ...
                    html.A(html.I(className='fab fa-github-square mr-1'), href='https://github.com/Tclack88/MountainProject'), 
